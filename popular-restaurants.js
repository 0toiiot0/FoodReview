...
(function () {
  ...
  const FALLBACK_PLACES = [
    { place_name: "을지로 노포집", category: "한식", address: "을지로3가" },
    { place_name: "합정 화덕피자", category: "이탈리안", address: "합정동" },
    { place_name: "망원동 손칼국수", category: "한식", address: "망원동" },
    { place_name: "성수 브런치클럽", category: "브런치", address: "성수동" },
    { place_name: "광장시장 마약김밥", category: "분식", address: "종로" },
    { place_name: "연남동 이자카야 하루", category: "이자카야", address: "연남동" }
  ];
